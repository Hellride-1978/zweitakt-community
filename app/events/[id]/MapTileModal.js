    ...
    <>
      ...
      >
        ...
        <div style={{ padding: '12px 16px 16px', borderTop: '1.5px solid var(--ink)' }}>
          <div style={{ fontFamily: 'var(--mono)', fontSize: 9, letterSpacing: 2, textTransform: 'uppercase', color: 'var(--accent)', marginBottom: 5 }}>Treffpunkt</div>
          {locationName && (
          ...
          >
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', padding: '16px 20px', borderBottom: '1.5px solid var(--ink)', gap: 16 }}>
              <div style={{ minWidth: 0 }}>
                <div style={{ fontFamily: 'var(--mono)', fontSize: 9, letterSpacing: 2, textTransform: 'uppercase', color: 'var(--accent)', marginBottom: 4 }}>Treffpunkt</div>
