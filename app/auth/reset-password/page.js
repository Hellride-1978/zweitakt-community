        ...
        <div className="zh-card">
          {done ? (
            ...
            <div>
              ...
              <a href="/auth/forgot-password" style={{ fontFamily: 'var(--mono)', fontSize: '11px', letterSpacing: '1.5px', textTransform: 'uppercase', color: 'var(--accent-accessible)', borderBottom: '1px solid var(--accent-accessible)' }}>
