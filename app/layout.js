...
export default function RootLayout({ children }) {
  return (
    ...
    >
      <head>
        <script dangerouslySetInnerHTML={{ __html: `(function(){var p={blue:{a:'rgb(155,195,214)',b:'rgb(175,210,225)',c:'rgb(210,230,238)',d:'rgb(100,155,180)',e:'#1a6080'},pink:{a:'#FF5C8F',b:'#ff85aa',c:'#ffb3cb',d:'#e0366a',e:'#9b0038'},sage:{a:'#7DC4A0',b:'#9DD4B8',c:'#C5E8D6',d:'#4FA87A',e:'#1e6640'},amber:{a:'#E8A045',b:'#F0BB78',c:'#F8DCBA',d:'#C07820',e:'#7a4400'},lilac:{a:'#A99BD4',b:'#C2B8E0',c:'#DDD8EF',d:'#7A68B8',e:'#3d2d8f'}};var k=localStorage.getItem('zh-palette')||'blue';var t=p[k]||p.blue;var r=document.documentElement.style;r.setProperty('--accent',t.a);r.setProperty('--accent-2',t.b);r.setProperty('--accent-3',t.c);r.setProperty('--accent-ink',t.d);r.setProperty('--accent-accessible',t.e);r.setProperty('--accent-hot',t.a);r.setProperty('--accent-hot-2',t.b);r.setProperty('--accent-hot-3',t.c);})();` }} />
      </head>
