...
const TECH = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Like-System', desc: 'DEAKTIVIERT 2026-09 (FEATURES.likes) — Buttons ausgehängt, Tabelle likes existiert noch. Likes auf Terminen, Profilen und Fahrzeugen — Supabase likes-Tabelle (target_type + target_id), optimistisches UI, Login-Prompt für Gäste', url: null },
      { name: 'Privat-Nachrichten', desc: 'DEAKTIVIERT 2026-09 (FEATURES.messages) — /messages liefert 404, Tabelle messages existiert noch. Inbox mit thread-basierter Ansicht, Ungelesen-Badge in Desktop-Nav und Mobile-Burger-Menü, E-Mail-Benachrichtigung bei neuer Nachricht via SMTP', url: null },
      ...
      { name: 'Kommentar-System', desc: 'DEAKTIVIERT 2026-09 (FEATURES.comments) — Kommentar-Blöcke ausgehängt, Tabelle comments existiert noch. Kommentare auf Terminen und Fahrzeugen – Supabase comments-Tabelle (target_type + target_id), nur für eingeloggte Mitglieder. E-Mail-Benachrichtigung an Ersteller und Teilnehmer via SMTP.', url: null },
      { name: 'Präsenz / Online-Status', desc: 'DEAKTIVIERT 2026-09 (FEATURES.presence) — Heartbeat aus, Spalte profiles.last_seen existiert noch. PresenceUpdater aktualisiert last_seen alle 5 Minuten in profiles – zeigt Online-Indikator (grüner Punkt) auf Profilkacheln. Kein Echtzeit-Kanal, nur Timestamp-basiert.', url: null },
      { name: 'Newsletter', desc: 'DEAKTIVIERT 2026-09 (FEATURES.newsletter) — Anmeldung und Versand aus, Abmelde-Route bleibt aktiv. Double-Opt-in Newsletter: Anmeldung via NewsletterForm (Footer) und NewsletterToggle (Profil-Settings), Bestätigungs-Mail + Willkommens-Mail via SMTP. Admin-Versand unter /admin/newsletter mit Live-Vorschau, Vorschau-Mail-Funktion und personalisiertem Abmelde-Link pro Empfänger. Abmeldung per Token-Link in jeder Mail oder über Account-Bereich.', url: null },
      ...
      { name: 'Onboarding-Tour', desc: 'DEAKTIVIERT 2026-09 (FEATURES.onboarding) — Komponente nicht mehr eingebunden. Schritt-für-Schritt Tour für neue User nach erster Anmeldung — localStorage-Trigger', url: null },
      ...
      { name: 'Forum — Die Anlaufstelle', desc: 'DEAKTIVIERT 2026-09 (FEATURES.forum) — /forum liefert 404, Tabellen und Bucket existieren noch. Q&A-Forum mit Posts, Antworten, optionalen Bild-Anhängen (Supabase Storage, Bucket: forum-images), Upvote/Downvote-System, Tag-Filterung (Marken-Dropdown + Themen-Pills), Server Actions mit Zod-Validierung, E-Mail-Benachrichtigung bei Antworten via Resend', url: null },
