...
export function rateLimit(key, maxRequests = 5, windowMs = 60_000) {
  ...
  // Abgelaufene Einträge aufräumen – sonst bleiben die IPs als Map-Keys für die
  // gesamte Lebensdauer der Serverless-Instanz liegen und die Map wächst unbegrenzt.
